                    ...
                    <div id="filtro-locarizacao" class="col-lg-6 col-md-6 col-sm-6 col-xl-13">
                      ...
                      <form id="filtroLocais" action="">
                        <ul class="list-inline">
                          ...
                          <li class="separator">|</li>
                          <li><input type="radio" name="a" class="img" data-radio="todos">TODOS</li>
                        </ul>
                      </form>
                      
                        
                    </div>
                    <img id="fare" class="img-center  img-responsive fare" src="img/mapa1.png">

                    <img id="pacta" class="img-center img-responsive pacta" src="img/mapa1.png">

                    <img  id="todos" class="img-center img-responsive pacta" src="img/mapa1.png">
