...
/**
 * OpportunityCardsFixture
 *
 */
class OpportunityCardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'opportunity_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
