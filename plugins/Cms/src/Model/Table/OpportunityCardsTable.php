...
use Cms\Model\Entity\OpportunityCard;

/**
 * OpportunityCards Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Opportunities
 */
class OpportunityCardsTable extends Table
{
    ...
    {
        $this->table('opportunity_cards');
        $this->displayField('name');
        $this->primaryKey('id');
        $this->belongsTo('Opportunities', [
            'foreignKey' => 'opportunity_id',
            'className' => 'Cms.Opportunities'
        ]);
    }
