  ...
  <body>
        ...
        <section class="container-fluid">
           <div id="ancora" class="row body">
                <div class="col-lg-1 col-md-1 col-sm-1 col-xl-1 linha-verde-lateral sombra-topo verde-3 hidden-xs auto-height"></div>
                <div class="col-lg-12 col-md-12 col-sm-12 sombra-interna borda-verde2 bg-cinza-escuro boxex auto-height">
                    <h2 class="tit-verde2"><span class="barra2"></span>PLANOS <span class="fontitalic">CONSULTING</span></h2>

                    <div class="row">

                      <form class="form form-planos" role="form" method="post" action="login" accept-charset="UTF-8" id="form-plano-consulting">

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xl-13">

                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="NOME" required name="nome-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="NOME DA EMPRESA" required name="nome-da-empresa-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control cnpj" id="" placeholder="CNPJ" required name="cnpj-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="ENDEREÇO" required name="endereco-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="BAIRRO" required name="bairro-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="CIDADE" required name="cidade-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="ESTADO" required name="estado-cadastro">
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xl-13">
                          <div class="form-group">
                              <input type="text" class="form-control telefone" id="" placeholder="TELEFONE" required name="telefone-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control tel-cel" id="" placeholder="CELULAR" required name="celular-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" id="" placeholder="E-MAIL" required name="email-cadastro">
                            </div>
                            <div class="form-group">
                              <input type="text" class="form-control" id="" placeholder="CONFIRME SEU E-MAIL" required name="nome">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" id="" placeholder="SENHA" required name="senha-cadastro">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="" placeholder="CONFIRME SUA SENHA" required name="assunto">
                            </div>
                            
                            <button type="submit" class="btn btn-success btn-verde">CONCLUIR CADASTRO</button>
                        </div>
                    </form> 
